// verify-donations.cjs - Verify donation dates in PostgreSQL
// Run with: node verify-donations.cjs
...
async function main() {
    ...
    `);
        ...
        if (invalidCount > 0) {
            console.log('WARNING: Found donations with invalid dates!');
            ...
            console.log('INFO: No donations found in database yet.');
        } else {
