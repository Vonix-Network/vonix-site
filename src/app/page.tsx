...
export default async function HomePage() {
  ...
  const statCards = [
    { label: 'Total Members', value: formatNumber(stats.users), icon: Users },
    { label: 'Servers', value: stats.servers.toString(), icon: Server },
    { label: 'Total Donated', value: formatCurrency(stats.donations), icon: Heart },
    { label: 'Community', value: 'Active', icon: Star },
  ];
