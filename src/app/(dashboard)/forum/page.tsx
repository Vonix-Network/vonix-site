  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div
        ...
        style={{
          background: `
            radial-gradient(ellipse 70% 60% at 0% 30%, rgba(139, 92, 246, 0.12) 0%, transparent 50%),
            radial-gradient(ellipse 60% 50% at 100% 70%, rgba(236, 72, 153, 0.10) 0%, transparent 45%),
            radial-gradient(ellipse 50% 40% at 50% 100%, rgba(0, 217, 255, 0.08) 0%, transparent 40%)
          `
        }}
      />

      {/* Glow orbs */}
      <div className="fixed top-20 -left-32 w-[600px] h-[600px] bg-neon-purple/15 rounded-full blur-[150px] pointer-events-none" />
      <div className="fixed bottom-20 -right-32 w-[500px] h-[500px] bg-neon-pink/12 rounded-full blur-[130px] pointer-events-none" />
